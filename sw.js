const CACHE_NAME = 'viltrum-fitness-v8.1.6';
const RUNTIME_CACHE = 'viltrum-runtime-v8.1.6';
const PRELOAD_CACHE = 'viltrum-preload-v8.1.6';
...
self.addEventListener('install', (event) => {
  console.log('[Service Worker] Installing v8.1.6...');
  event.waitUntil(
    caches.open(CACHE_NAME)
      .then((cache) => {
        console.log('[Service Worker] Caching app shell v8.1.6');
...
self.addEventListener('activate', (event) => {
  console.log('[Service Worker] Activating v8.1.6...');
  event.waitUntil(
