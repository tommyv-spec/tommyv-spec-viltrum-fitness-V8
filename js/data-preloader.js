...
const DataPreloader = {
  ...
  async loadAll(email) {
    ...
    // Old monolithic cache (viltrum_user_cache) skipped — had broken rounds/percentage data
    // Will be cleaned up naturally by _migrateOldCache which removes the key
