const CACHE_NAME = 'viltrum-fitness-v8.2.24';
const RUNTIME_CACHE = 'viltrum-runtime-v8.2.24';
const PRELOAD_CACHE = 'viltrum-preload-v8.2.24';
const BUILD_HASH = '20260516221000';
...
self.addEventListener('install', (event) => {
  console.log('[Service Worker] Installing v8.2.24...');
  event.waitUntil(
    caches.open(CACHE_NAME)
      .then((cache) => {
        console.log('[Service Worker] Caching app shell v8.2.24');
...
self.addEventListener('activate', (event) => {
  console.log('[Service Worker] Activating v8.2.24...');
  event.waitUntil(
