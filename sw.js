const CACHE_NAME = 'viltrum-fitness-v8.2.32';
const RUNTIME_CACHE = 'viltrum-runtime-v8.2.32';
const PRELOAD_CACHE = 'viltrum-preload-v8.2.32';
const BUILD_HASH = '20260715210941';
...
self.addEventListener('install', (event) => {
  console.log('[Service Worker] Installing v8.2.32...');
  event.waitUntil(
    caches.open(CACHE_NAME)
      .then((cache) => {
        console.log('[Service Worker] Caching app shell v8.2.32');
      ...
      .then(() => {
        console.log('[Service Worker] Install complete - waiting for activation');
        // NOTE: Do NOT call skipWaiting() here.
        // Let update-notifier.js show the "Aggiorna" banner first,
        // then send SKIP_WAITING when user clicks the button.
      })
      .catch((error) => {
...
self.addEventListener('activate', (event) => {
  console.log('[Service Worker] Activating v8.2.32...');
  event.waitUntil(
