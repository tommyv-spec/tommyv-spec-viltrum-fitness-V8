const CACHE_NAME = 'viltrum-fitness-v8.2.76';
const RUNTIME_CACHE = 'viltrum-runtime-v8.2.76';
...
const BUILD_HASH = '20260819002257';
...
self.addEventListener('install', (event) => {
  console.log('[Service Worker] Installing v8.2.76...');
  event.waitUntil(
    caches.open(CACHE_NAME)
      .then((cache) => {
        console.log('[Service Worker] Caching app shell v8.2.76');
...
self.addEventListener('activate', (event) => {
  console.log('[Service Worker] Activating v8.2.76...');
  event.waitUntil(
